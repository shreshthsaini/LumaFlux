...
Linear-light terms use the inverse PQ EOTF; the spline smoothness penalty
stabilizes adjacent RQS knot slopes.
"""
...
from ..color.transfer import pq_eotf
...
def reconstruction_losses(
    ...
    """Both frames are PQ/BT.2020 signals in [0,1]."""
    pred_lin = pq_eotf(hdr_pred_pq)
    tgt_lin = pq_eotf(hdr_target_pq)
